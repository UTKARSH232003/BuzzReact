...
<Router>
  ...
  <Routes>
    <Route path="/" element={<News setProgress={this.setProgress} key= "general" pageSize={this.pageSize} country="in" category="general" />} /> {/* Replace <Home /> with the desired component for the root route */}
    <Route path="/general" element={<News setProgress={this.setProgress} key= "general" pageSize={this.pageSize} country="in" category="general" />} /> {/* Replace <Home /> with the desired component for the root route */}
